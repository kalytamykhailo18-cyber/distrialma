...
export default function MovimientoDetail() {
  ...
  const dataReady = useDataReady(movement);
        ...
        <div className="bg-white border rounded-xl overflow-hidden mb-4 shadow-sm">
          ...
          <div className="divide-y">
            {movement.items.map((item, idx) => (
              <div
                key={item.id}
                className={`px-4 py-3 flex items-center justify-between ${hoverRow}`}
        ...
        <Stagger delay={200} y={10}>
          <div className="flex gap-3">
            <button
              ...
              disabled={approving}
              className={`flex-1 flex items-center justify-center gap-2 py-3 text-sm font-medium text-white bg-green-600 rounded-xl hover:bg-green-700 shadow-sm disabled:opacity-50 ${springBtn}`}
            >
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 px-6 py-3 text-sm font-medium text-red-600 bg-red-50 border border-red-200 rounded-xl hover:bg-red-100 shadow-sm ${springBtn}`}
            >
