        ...
        {loading ? <LoadingCenter /> : !data ? <p className="text-gray-400">Sin datos</p> : (
          <Stagger delay={150}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
              {[
                { value: globalVentas.toLocaleString("es-AR"), label: "Ventas", color: "text-gray-900" },
                { value: fmtK(globalTotal), label: "Facturado", color: "text-blue-600" },
                { value: fmtK(globalGanancia), label: "Ganancia", color: "text-green-600" },
                { value: `${globalMargen}%`, label: "Margen", color: "text-brand-600" },
              ].map((card, i) => (
