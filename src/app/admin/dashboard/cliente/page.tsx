...
export default function ClienteDetailPage() {
  ...
  return (
    <PageTransition className="max-w-4xl mx-auto px-4 py-6">
      <Stagger delay={0} y={-8}>
        <Link href="/admin/dashboard" className={`inline-flex items-center gap-1 text-sm text-brand-600 hover:text-brand-700 mb-4 ${springBtn}`}>
      ...
      <Stagger delay={240} y={10}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          {/* Top products */}
          <div className="bg-white border rounded-xl p-4 overflow-hidden shadow-sm">
        ...
        <div className="bg-white border rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="divide-y">
            {data.ultimasCompras.map((c, i) => (
              <div key={c.boleta} className={`px-4 py-2.5 flex items-center justify-between ${hoverRow}`} style={staggerStyle(true, i)}>
                <div>
